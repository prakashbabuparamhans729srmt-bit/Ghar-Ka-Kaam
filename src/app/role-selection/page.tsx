      ...
      <Card className="w-full max-w-md bg-transparent border-0 shadow-none text-white">
        <CardHeader>
          <div className="flex items-center gap-4 relative">
            <Button variant="outline" size="icon" className="absolute -left-1 bg-transparent hover:bg-white/10 text-white hover:text-white border-white/20" asChild>
        ...
        <CardContent>
          ...
          >
            <Label
              htmlFor="customer"
              className="flex cursor-pointer items-start space-x-4 rounded-md border border-white/20 p-4 transition-all hover:bg-white/10 has-[[data-state=checked]]:border-cyan-400 has-[[data-state=checked]]:bg-cyan-900/20 has-[[data-state=checked]]:shadow-md"
            >
              <RadioGroupItem value="customer" id="customer" className="border-white/50 text-cyan-400" />
            ...
            <Label
              ...
              className="flex cursor-pointer items-start space-x-4 rounded-md border border-white/20 p-4 transition-all hover:bg-white/10 has-[[data-state=checked]]:border-cyan-400 has-[[data-state=checked]]:bg-cyan-900/20 has-[[data-state=checked]]:shadow-md"
            >
              <RadioGroupItem value="provider" id="provider" className="border-white/50 text-cyan-400" />
              <div className="space-y-1">
            ...
            <Label
              htmlFor="partner"
              className="flex cursor-pointer items-start space-x-4 rounded-md border border-white/20 p-4 transition-all hover:bg-white/10 has-[[data-state=checked]]:border-cyan-400 has-[[data-state=checked]]:shadow-md opacity-50"
            >
              <RadioGroupItem value="partner" id="partner" disabled className="border-white/50 text-cyan-400" />
              <div className="space-y-1">
        ...
        <CardFooter className="flex flex-col gap-2">
          <Button className="w-full bg-cyan-400 text-black hover:bg-cyan-500 font-bold" onClick={handleContinue}>
            {t('continue')}
          </Button>
        </CardFooter>
      </Card>
