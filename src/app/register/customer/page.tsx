  ...
  return (
      <Card className="w-full max-w-lg bg-transparent border-0 shadow-none">
            <CardHeader>
              ...
              <CardDescription className="text-muted-foreground">{t('customerRegistration_description')}</CardDescription>
            </CardHeader>
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)}>
                   ...
                   <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder={t('customerRegistration_namePlaceholder')} {...field} className="focus-visible:ring-ring" />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                      ...
                      <FormItem>
                        ...
                        <FormControl>
                          <div className="relative">
                            <Input placeholder={t('customerRegistration_addressPlaceholder')} {...field} className="focus-visible:ring-ring" />
                            <Button
                              type="button"
                              variant="ghost"
                              size="icon"
                ...
                <CardFooter>
                  <Button type="submit" className="w-full bg-primary text-primary-foreground hover:bg-primary/90 font-bold">{t('complete_registration')}</Button>
                </CardFooter>
              </form>
            </Form>
      </Card>
